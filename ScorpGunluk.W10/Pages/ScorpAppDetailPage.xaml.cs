//---------------------------------------------------------------------------
//
// <copyright file="ScorpAppDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class ScorpAppDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public ScorpAppDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new ScorpAppSection());
