//---------------------------------------------------------------------------
//
// <copyright file="ScorpSakalarDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class ScorpSakalarDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public ScorpSakalarDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new ScorpSakalarSection());
