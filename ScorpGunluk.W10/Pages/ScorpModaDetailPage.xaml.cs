//---------------------------------------------------------------------------
//
// <copyright file="ScorpModaDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class ScorpModaDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public ScorpModaDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new ScorpModaSection());
