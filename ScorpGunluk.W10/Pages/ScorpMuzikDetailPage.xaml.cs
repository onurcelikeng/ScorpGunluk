//---------------------------------------------------------------------------
//
// <copyright file="ScorpMuzikDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class ScorpMuzikDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public ScorpMuzikDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new ScorpMuzikSection());
