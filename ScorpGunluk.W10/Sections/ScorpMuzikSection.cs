...
{
    public class ScorpMuzikSection : Section<YouTubeSchema>
    {
		private YouTubeDataProvider _dataProvider;
		

		public ScorpMuzikSection()
		{
        ...
        public override ListPageConfig<YouTubeSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<YouTubeSchema>
                {
                    ...
                    Page = typeof(Pages.ScorpMuzikListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.ScorpMuzikDetailPage>(true);
                    }
                };
            }
        }
