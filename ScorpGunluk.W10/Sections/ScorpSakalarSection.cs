...
{
    public class ScorpSakalarSection : Section<YouTubeSchema>
    {
		private YouTubeDataProvider _dataProvider;
		

		public ScorpSakalarSection()
		{
        ...
        public override ListPageConfig<YouTubeSchema> ListPage
        {
            get 
            {
                ...
                {
                    Title = "Scorp Şakaları",

                    Page = typeof(Pages.ScorpSakalarListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.ScorpSakalarDetailPage>(true);
                    }
                };
            }
        }
